...
cf_data_string = './colab/data/data_cf_' + core_str + '.csv'
numpy.savetxt(cf_data_string, cost_f, delimiter=",")
sg_data_string = './colab/data/data_sg_' + core_str + '.csv'
...
plt.savefig('./colab/plots/colormap_cost_f_' + core_str + '.png', bbox_inches='tight')
