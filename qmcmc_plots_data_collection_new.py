...
figure.tight_layout(h_pad=10, w_pad=4)  # distances between subplots
# printin plots
if cost_f_choice == 'ACF':
    # spectral gap
    ...
    # cost function  # TODO: normalize cost fucntion such that u can compare with axis (if you divide by n-t is already normalized)
    ...
    axis[1].set_xlabel('Optimization steps', fontsize=17) # labelpad=10
    ...
    # correlation
    axis[2].scatter(cf_mean, sg_mean, color='red')  # , markersize=10, marker='o'
    axis[2].grid(linestyle='--')
    # if subplots_n == 2:
    #     pass
    # else:
    #     axis[1].set_xticklabels([])
    axis[2].set_ylabel('Spectral gap $\delta$', fontsize=20, labelpad=10)
    axis[2].set_xlabel('Cost function $' + cost_f_choice + '$', fontsize=17) # labelpad=10
...
png_name = './simulations_plots/' + cost_f_choice + '/' + 'plot_OPT_' + core_str + \
